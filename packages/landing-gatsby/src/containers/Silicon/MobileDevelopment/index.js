...
import SectionWrapper, { CarouselWrapper } from "./mobileDevelopment.style";
import FeatureBlock from "../../../../../common/src/components/FeatureBlock";

const MobileDevelopment = (featureDescription, featureTitle) => {
  const data = useStaticQuery(graphql`
    query {
      mobileDevelopmentJson {
        features {
          title
          description
        }
  ...
  const { features } = data.mobileDevelopmentJson;
